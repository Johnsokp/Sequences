...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [272, 84, 70, -10, 40]
    threshold = sequence[3]
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 5
    actual = count_positive_sines([7, 7, 4, 9, 9, 9, 6, 6, 6, 6, 6])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = -356
    actual = sum_first_n([1, -357, 548], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
